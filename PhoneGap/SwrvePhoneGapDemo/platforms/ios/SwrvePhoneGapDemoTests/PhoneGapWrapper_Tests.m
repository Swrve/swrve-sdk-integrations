...
{
    NSString* response = [((UIWebView*)controller.webView) stringByEvaluatingJavaScriptFromString:js];
    NSLog(@"Javascript call '%@' response: %@", js, response);
    return response;
}
