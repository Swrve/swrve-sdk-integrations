...
@interface SwrvePhoneGapDemoTests : XCTestCase {
...
@implementation SwrvePhoneGapDemoTests
...
- (void)setUp
{
    ...
    NSURL* path = [[NSBundle bundleForClass:[SwrvePhoneGapDemoTests class]] URLForResource:@"test_campaigns_and_resources" withExtension:@"json"];
    ...
    [TestHTTPConnection setHandler:@"/cdn/" handler:^NSObject<HTTPResponse>*(NSString* urlPath, HTTPMessage *request) {
        ...
        NSURL* url = [[NSBundle bundleForClass:[SwrvePhoneGapDemoTests class]] URLForResource:fileName withExtension:nil];
